...
ATTR_POWER_ON_HRS = 'power_on_hours'
ATTR_POWER_CYCLES = 'power_cycles'
ATTR_UNSAFE_SHUT = 'unsafe_shutdowns'
ATTR_MEDIA_ERRORS = 'media_errors'
ATTR_PERCENT_USED = 'percentage_used'
ATTR_AVAIL_SPARE = 'available_spare'
ATTR_CRIT_WARN = 'critical_warning'
ATTR_WARN_TEMP_TIME ='warning_temperature_time'
...
CHARTS = {
    ...
    'critical_warning': {
        'options': [None, 'Critical Warning', 'events', 'external failure',
                    'smartd_log.critical_warning', 'line'],
        'lines': [],
        'attrs': [ATTR_CRIT_WARN],
        'algo': ABSOLUTE,
    },
    'udma_crc_error_count': {
    ...
    'warning_temperature_time': {
        'options': [None, 'Warning Temperature Time', 'sec', 'temperature', 'smartd_log.warning_temperature_time', 'line'],
        'lines': [],
        'attrs': [ATTR_WARN_TEMP_TIME],
        'algo': ABSOLUTE,
    },
    'reallocated_sectors_count': {
    ...
    'offline_uncorrectable_sector_count': {
        ...
        'lines': [],
        'attrs': [ATTR198, ATTR_MEDIA_ERRORS],
        'algo': ABSOLUTE,
    ...
    'percent_lifetime_used': {
        ...
        'lines': [],
        'attrs': [ATTR202, ATTR_PERCENT_USED],
        'algo': ABSOLUTE,
    },
    'media_wearout_indicator': {
    ...
    'available_spare': {
        'options': [None, 'Available Spare', 'percentage', 'wear', 'smartd_log.available_spare', 'line'],
        'lines': [],
        'attrs': [ATTR_AVAIL_SPARE],
        'algo': ABSOLUTE,
    },
    'nand_writes_1gib': {
...
class NVMERaw(BaseNVMESmartAttribute):
    def value(self):
        return self.raw_value
...
def nvme_attribute_factory(value):
    return NVMERaw(*value)
...
class Service(SimpleService):
    ...
    def create_disk_from_file(self, full_name, current_time):
        ...
        elif NVME in full_name:
            disk = NVMEDisk(name, DiskLogFile(path))
        else:
